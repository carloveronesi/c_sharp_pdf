...
namespace ElaborazionePdf
{
	public class PdfDocument
	{
				...
				{ 
					...
					foreach (KeyValuePair<string, AcroFields.Item> kvp in form.Fields)
					{
						...
						if (form.GetFieldType(kvp.Key) == AcroFields.FIELD_TYPE_SIGNATURE)
						{
							...
							checkbox.BorderWidth = BaseField.BORDER_WIDTH_THIN;
		...
		{
			PdfDocument p = new PdfDocument("../Richiesta di adesione e Condizioni relative all'uso della firma elettronica avanzata_signaturefield.pdf");
